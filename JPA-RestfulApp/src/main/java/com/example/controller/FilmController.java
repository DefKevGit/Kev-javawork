...
public class FilmController
{
	...
	@GetMapping("/readByDirector/{director}")
	public ResponseEntity<List<Film>> readByDirector(@PathVariable String director)
	{
		return ResponseEntity.ok(this.service.readByDirector(director));
	}

	@GetMapping("/readByDirBox/{director}/{boxOffice}")
	public ResponseEntity<List<Film>> readByDirBox(@PathVariable String director, @PathVariable int boxOffice)
	{
		return ResponseEntity.ok(this.service.readByDirBox(director, boxOffice));
	}
}
